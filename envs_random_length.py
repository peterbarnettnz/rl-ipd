...
class TwoAgentMatrixGameEnv(MultiAgentEnv):
    ...
    def history_to_states(self, history=None):
        ...
        state1 = history[:,:,:self.state_len].flatten()
        state2 = history[::-1,:,:self.state_len].flatten()
...
class TwoAgentMatrixGameNoHistoryEnv(MultiAgentEnv):
    ...
    def lastmoves_to_state(self, last_moves=None):
        ...
        state1 = last_moves.flatten()
        state2 = last_moves[::-1,:].flatten()
        states = {0: state1, 1:state2}
        return states
    ...
    def step(self, action_dict):
        ...
        self.last_moves[0, action_dict[0]] = 1
        self.last_moves[1, action_dict[1]] = 1
